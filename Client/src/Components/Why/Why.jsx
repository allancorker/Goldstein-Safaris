...
const Why = () => {
  const features = [
    ...
    { icon: local, title: "Locally Based Guides", description: "At Goldstein Safaris, our Chief Experience Officers know every destination like the back of their hand." },
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="mb-8">
      <h2 className="text-3xl font-bold text-left  text-gray-800">Why Travel with Goldstein Safaris?</h2>
